...
a-commands{target="_blank"} provides easy-to-use tools for basic usage of Allas. The functions to use for data movement between Puhti and Allas are:

* a-put{target="_blank"}: Move data from Puhti to Allas
* a-get{target="_blank"}: Move data from Allas to Puhti 
...
```
For more information, see Swift client{target="_blank"}.
...
For further guidance for using rclone with Allas from Supercomputers, see Using Allas with rclone from Puhti{target="_blank"}.

## Move data with s3cmd

For data movement between Puhti and Allas s3cmd{target="_blank"} provides functions:

* put{target="_blank"} move data from Puhti to Allas

* get{target="_blank"}: move data from Allas to Puhti

More examples of using s3cmd from Supercomputers can be found here{:target="_blank"}.
