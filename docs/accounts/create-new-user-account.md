...
LUMI User must register in MyAccessID Registration Portal. 
National portal or Puhuri Portal shall lead to the registration portal.

The authentication on the portal done with home organisation identity provider, which can be selected from the list. 
In case that is not possible please contact LUST team https://lumi-supercomputer.eu/user-support/need-help/account/ with the error message.
