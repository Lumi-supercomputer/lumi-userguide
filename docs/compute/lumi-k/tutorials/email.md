...
If you want to set up any services on _Lumi-K_ that generate a large amount of SMTP traffic (e.g. public mailing lists), please contact the CSC Service Desk to coordinate this.
...
* The relay SMTP server will only allow to send emails from clients from certain IPs, like from LUMI-K nodes. In other words, the script above will not work from your desktop/laptop.
