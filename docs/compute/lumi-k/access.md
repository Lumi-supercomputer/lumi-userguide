...
# Getting access to LUMI-K

## Login using a CSC account

In order to use the LUMI-K container cloud with a CSC account, you need:
...
2. A computing project with access to LUMI-K

Access to another CSC computing system such as cPouta, Mahti or Puhti counts as a valid computing project. The same 
project can be used in to access LUMI-K after adding this later to the list of enabled services.

### Applying for access

Apply for LUMI-K access for a computing project in the
...
3. Select the project you want to add LUMI-K access for in the
   project list.
4. In the list of CSC services, click LUMI-K's dropdown menu.
...
7. Wait up to 30 min for your profile and privileges to sync in LUMI-K.

If you don't have a suitable computing project for LUMI-K
