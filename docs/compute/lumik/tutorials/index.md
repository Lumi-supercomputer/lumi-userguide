...
* 🟢 [Setup a HTTP redirection in LUMI-K](http-redirector.md)
* 🟢 [Short introduction to YAML](yaml_introduction.md)
* 🟢 [Webhooks](webhooks.md)
* 🟢 [Allow pulls of images from one LUMI-K project to another](allow-pull-from-other-projects.md)
...
* 🟠 [Sending e-mail from LUMI-K](email.md)


## Advanced level

* 🔴 [4cat, deploying and adapting an application](4cat.md)
* 🔴 [Accessing databases on LUMI-K from CSC supercomputers](connect-database-hpc.md)
* 🔴 [Advanced NetworkPolicies](advanced-NetworkPolicies-networking.md)
* 🔴 [CI/CD on LUMI-K](ci_cd_introduction.md)
...
We also have an [FAQ](../../../support/faq/index.md#LUMI-K) for LUMI-K. Take a look at it.
