...
!!! success "Basic level"
    This is a simple tutorial to show how to deploy a web server using the LUMI-K [web interface](../usage/getting_started.md) using a git repository as a source

# Deploy from Git

How to set up a static web server in LUMI-K from a Git repository.
